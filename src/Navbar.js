  ...
  return (
    <div>
      <div className="fixed top-3 left-0  right-0 z-50 flex justify-center px-4">
        <div className="bg-white flex border border-gray-300 items-center mx-5 sm:mx-0 justify-between rounded-full px-3 sm:px-8 py-3 w-full sm:w-6/12 shadow-lg">
